<template>
  <div v-loading="loading2" element-loading-text="拼命加载中"
    ...
    <div class="underHeader">
      ...
      <el-input placeholder="请输入医生名称" size="medium" v-model="form.doctorName"></el-input>
      </el-form-item>
      <!-- <el-form-item label="所在科室：">
      <el-input placeholder="请输入该医生所在科室" size="medium" v-model="form.office"></el-input>
      </el-form-item> -->
      <el-select v-model="form.office" placeholder="请选择医生所在科室">
      <el-option
      ...
      <el-button type="primary" @click="addDoctor">录 入</el-button>
    ...
    <div>
      ...
      <span class="btnBox">
        <el-button size="small" @click="delDoctor(scope)">删除</el-button>
      </span>
      </template>
    </el-table-column>
  </el-table>
